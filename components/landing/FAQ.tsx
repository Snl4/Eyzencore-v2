...
const ITEMS = [
  ...
  { q:'Хто стоїть за Eyzencore?',
    a:"Команда українських розробників та активних гравців Minecraft. Платформа з'явилась у 2025 році як реакція на відсутність якісних україномовних рішень для спільноти." },
];
